...
class InSearchOfCreatePost extends StatelessWidget {
  ...
  InSearchOfCreatePost({super.key});
 ...
 Widget _amount(BuildContext context){
    return Padding(
      ...
      child: Text(
        '¿Cuál es el precio máximo que estás dispuesto a pagar?(opcional)',
        style: TextStyle(
          fontSize: 20,
          fontWeight: FontWeight.bold
        ),
 ...
 Widget _photosRequest(BuildContext context){
    return Padding(
      padding: const EdgeInsets.all(13.0),
      child: Text(
        'Sube al menos 1 foto de referencia:',
        style: TextStyle(
          fontSize: 20,
          fontWeight: FontWeight.bold
        ),
  ...
  Widget _description(BuildContext context){
    return Padding(
      padding: const EdgeInsets.all(13.0),
      child: Text(
        'Describe el producto que estás buscando',
        style: TextStyle(
          fontSize: 20,
          fontWeight: FontWeight.bold
        ),
            ...
            return BasicReactiveButton(
              onPressed: (){
                ...
                context.read<ButtonStateCubit>().execute(
                  usecase: CreateIsoPostUseCase(),
                  params: InSearchOfModel(
                    buyerId: null,
                    buyerDisplayName: userFirstName,
                    status: "En busca",
                    name: _nameCon.text,
                    dealDetails: "Trato en espera de encontrar alguien que tenga el producto",
                    details: _descriptionCon.text,
                    typeOfProduct: userType==1 ? 'Original' : 'Reproducción',
                    typeOfDeal: dealType==1 ? 'Envío' : 'En persona',
                    reward: _amountCon.text.isEmpty ? null : double.parse(_amountCon.text).toString(),
