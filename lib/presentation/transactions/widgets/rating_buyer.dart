...
class RatingBuyer extends StatelessWidget {
  final TransactionEntity transaction;
  final String currentUserId;
  final StatusEntity status;
  final MultiSelectController _multiCon = MultiSelectController();
  RatingBuyer({super.key, required this.transaction, required this.status, required this.currentUserId});
                               ...
                               builder: (context) {
                                 return Padding(
                                   ...
                                   child: CustomReactiveButton(
                                            ...
                                            params: StatusModel(
                                                status: "Completado", 
                                                details: "El Vendedor ha emitido una calificación al comprador", 
                                                ...
                                                completedRatingMessageForBuyer: _multiCon.getSelectedItems(),
                                                buyerRating: context.read<RatingSelectionCubit>().selectedIndex,
                                            )
                                          );
                                                      }
                                                      else {
